...
Namespace RnrBooksDataSetTableAdapters
    ...
    Partial Public Class BooksTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Books` SET `ISBN` = ?, `Title` = ?, `Author` = ?, `Publisher` = ? WHERE ("& _ 
                "(`ISBN` = ?) AND ((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND "& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ISBN, Title, Author, Publisher FROM Books"
